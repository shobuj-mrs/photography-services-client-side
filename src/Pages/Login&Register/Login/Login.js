...
const Login = () => {
    ...
    return (
        <div className="hero-content grid gap-6 md:grid-cols-2 flex-col lg:flex-row">
            ...
            <div className="w-full max-w-md p-8 space-y-3 rounded-xl  shadow-2xl mx-auto">
                ...
                <form
                    ...
                    <div className="space-y-1 text-sm">
                        ...
                        <input type="email" name="email" placeholder="email" required className="w-full px-4 py-3 rounded-md bg-cyan-100 text-black" />
                    </div>

                    <div className="space-y-1 text-sm">
                        <label htmlFor="password" className="block">Password</label>
                        <input type="password" name="password" placeholder="Password" required className="w-full px-4 py-3 rounded-md bg-cyan-100" />
                ...
                <p className='text-center'>Don't have an account?
                    <Link rel="noopener noreferrer" to={'/signin'} className='text-orange-600 font-bold'>Sign up</Link>
                </p>
